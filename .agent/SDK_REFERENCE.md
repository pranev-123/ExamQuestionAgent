...
sdk.entities.query_entity_records(sql_query: str, source: Optional[str]=None) -> typing.List[typing.Dict[str, typing.Any]]

# Asynchronously query entity records using a validated SQL query.
sdk.entities.query_entity_records_async(sql_query: str, source: Optional[str]=None) -> typing.List[typing.Dict[str, typing.Any]]
